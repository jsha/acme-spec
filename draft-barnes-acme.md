...
Before revoking a certificate, the server MUST verify one of these conditions
applies:
- the key pair signing the request is the account key under which the
